...
export const COMMANDS = {
  ...
  EXPORT_APPEARANCES_TO_AEC_BUNDLE: 'export_appearances_to_aec_bundle',
  ...
  PREVIEW_REORGANIZE_APPEARANCE_IDS: 'preview_reorganize_appearance_ids',
  REORGANIZE_APPEARANCE_IDS: 'reorganize_appearance_ids',
  ...
  APPLY_OUTFIT_REMAP_TO_MONSTERS: 'apply_outfit_remap_to_monsters',
  ...
  APPLY_ID_REMAP_TO_NPCS: 'apply_id_remap_to_npcs',
  ...
  APPLY_OUTFIT_REMAP_TO_STATICDATA: 'apply_outfit_remap_to_staticdata',
  ...
  UPDATE_STATICDATA_ACHIEVEMENT: 'update_staticdata_achievement',
  ...
  GET_STATICDATA_ACHIEVEMENTS: 'get_staticdata_achievements',
  ...
  // Client config (config.ini URLs + BattleEye toggle)
  GET_CLIENT_URLS: 'get_client_urls',
  SAVE_CLIENT_URLS: 'save_client_urls',
  GET_BATTLEYE_STATUS: 'get_battleye_status',
  SET_BATTLEYE_ENABLED: 'set_battleye_enabled',
  GET_RSA_MODULUS: 'get_rsa_modulus',
  SET_RSA_MODULUS: 'set_rsa_modulus',
